 ...
 */
@Data
public class CodeScanJobDto implements Serializable {
    private static final long serialVersionUID = 109274842804L;
    private static final Logger logger = LoggerFactory.getLogger(CodeScanJobDto.class);
    ...
    private List<CodeScanJobRecordDataDto> polyLine;

    private List<PieDto> pieData;
}
