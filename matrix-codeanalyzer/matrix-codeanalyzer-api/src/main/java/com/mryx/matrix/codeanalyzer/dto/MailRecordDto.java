...
import com.mryx.matrix.codeanalyzer.domain.Issue;
import lombok.Data;
...
@Data
public class MailRecordDto implements Serializable {
    private static final long serialVersionUID = 10907074842804L;
