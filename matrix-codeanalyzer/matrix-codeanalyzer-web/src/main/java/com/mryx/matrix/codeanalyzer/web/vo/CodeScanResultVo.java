 ...
 */
@Data
public class CodeScanResultVo extends Page implements Serializable {
    private static final long serialVersionUID = 7301345507074842804L;
    private static final Logger logger = LoggerFactory.getLogger(CodeScanResultVo.class);
