...
public class Cg {
    ...
    private final String bean_package = "com.mryx.matrix.codeanalyzer.domain";

    private final String mapper_package = "com.mryx.matrix.codeanalyzer.core.dao";

    private final String service_package = "com.mryx.matrix.codeanalyzer.core.service.impl";

    private final String i_service_package = "com.mryx.matrix.codeanalyzer.core.service";

    private final String driverName = "com.mysql.jdbc.Driver";

    private final String user = "grampus";
...
//        return beanName.substring(0, 1).toLowerCase() + beanName.substring(1);//用别名
    ...
    private BufferedWriter buildClassComment(BufferedWriter bw, String text) throws IOException {
        ...
        bw.write(" * " + text);
        bw.newLine();
        bw.write(" * @author zhaoxl");
        bw.newLine();
        bw.write(" * @email zhaoxl02@missfresh.cn");
        bw.newLine();
...
//        bw.write("\t\t <include refid=\"orderBy\" />");
    ...
    public static void main( String[] args ) {
        ...
        // domain 存放地址
        String beanPath = baseDir + "/matrix-codeanalyzer-api/src/main/java/com/mryx/matrix/codeanalyzer/domain/";
        // dao 存放地址
        String mapperPath = baseDir + "/matrix-codeanalyzer-core/src/main/java/com/mryx/matrix/codeanalyzer/core/dao/";
        // serviceImpl 存放地址
        String servicePath = baseDir + "/matrix-codeanalyzer-core/src/main/java/com/mryx/matrix/codeanalyzer/core/service/impl/";
        // service 接口存放地址
        String iServicePath = baseDir + "/matrix-codeanalyzer-core/src/main/java/com/mryx/matrix/codeanalyzer/core/service/";
        // xml 存放地址
        String xmlPath = baseDir + "/matrix-codeanalyzer-core/src/main/resources/Mapper/";

        String[] array = {"beta_delpoy_record","release_delpoy_record"};
