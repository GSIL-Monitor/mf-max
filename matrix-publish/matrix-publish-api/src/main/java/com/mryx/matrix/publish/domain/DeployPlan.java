 ...
 * @date 2018/10/19
 */
public class DeployPlan extends Page implements Serializable {

    private static final long serialVersionUID = -391778092071463063L;
     ...
     * 关联机器信息
     */
    private List<PlanMachineMapping> planMachineMappings;
    ...
    public List<PlanMachineMapping> getPlanMachineMappings() {
        return planMachineMappings;
    }

    public void setPlanMachineMappings(List<PlanMachineMapping> planMachineMappings) {
