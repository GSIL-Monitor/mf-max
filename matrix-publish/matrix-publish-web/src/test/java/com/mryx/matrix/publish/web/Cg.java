...
public class Cg {
    ...
    private final String bean_package = "com.mryx.matrix.publish.domain";

    private final String mapper_package = "com.mryx.matrix.publish.core.dao";

    private final String service_package = "com.mryx.matrix.publish.core.service.impl";

    private final String i_service_package = "com.mryx.matrix.publish.core.service";
...
//        bw.write("\t\t <include refid=\"orderBy\" />");
    ...
    public static void main( String[] args ) {
        ...
        // domain 存放地址
        String beanPath = baseDir + "/matrix-publish-api/src/main/java/com/mryx/matrix/publish/domain/";
        // dao 存放地址
        String mapperPath = baseDir + "/matrix-publish-core/src/main/java/com/mryx/matrix/publish/core/dao/";
        // serviceImpl 存放地址
        String servicePath = baseDir + "/matrix-publish-core/src/main/java/com/mryx/matrix/publish/core/service/impl/";
        // service 接口存放地址
        String iServicePath = baseDir + "/matrix-publish-core/src/main/java/com/mryx/matrix/publish/core/service/";
        // xml 存放地址
        String xmlPath = baseDir + "/matrix-publish-core/src/main/resources/Mapper/";
